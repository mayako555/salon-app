...
const ruleSections = [
  {
    ...
    icon: Shield,
    content: `第1条（目的）
本規則は、Jasmine Lash（以下「会社」という）における労働条件、服務規律その他就業に関する事項を定め、スタッフ全員が安心して働ける環境を整備するとともに、「接客・技術・空間すべてにおいて五つ星クオリティのサービスを提供する」という理念のもと、一定基準以上のサービス品質を維持することを目的とする。
...
詳細は別途定める。`
  },
  {
    ...
    icon: GraduationCap,
    content: `第19条（基本姿勢）
従業員は、Jasmine Lashの理念およびブランドコンセプトを理解し、誠実かつ丁寧な接客・施術を行わなければならない。
      ...
      <div className="bg-slate-900 p-8 rounded-3xl text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 font-medium max-w-xl leading-relaxed">
            Jasmine Lashの理念に基づき、スタッフ全員が安心してプロフェッショナルとして活躍するための基準を定めています。
          </p>
